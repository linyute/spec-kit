...
感謝您協助讓 GitHub 對所有人來說都安全。

GitHub 非常重視我們軟體產品和服務的安全性，包括透過我們的 GitHub 組織 (例如 [GitHub](https://github.com/GitHub)) 管理的所有開源程式碼儲存庫。

儘管 [開源儲存庫不在我們錯誤獎勵計畫的範圍內](https://bounty.github.com/index.html#scope)，因此不符合獎勵資格，但我們將確保您的發現會傳達給適當的維護者進行補救。
